...
*/
class ChangeDownloadPathWidget final : public TranslucentWidget {
    Q_OBJECT
  public:
...
// 更改PixivCookie的窗口
class ChangePixivCookieWidget final : public TranslucentWidget {
    Q_OBJECT
  public:
...
// 更改背景图片透明度的窗口
class ChangeTransparencyWidget final : public TranslucentWidget {
    Q_OBJECT
  public:
...
// 更改背景图片的窗口
class ChangeBackgroundImageWidget final : public TranslucentWidget {
    Q_OBJECT
  public:
